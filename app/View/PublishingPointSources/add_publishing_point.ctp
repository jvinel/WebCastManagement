...
<?php $this->start('breadcrumb'); ?>
    ...
    <li><?php echo $this->Html->link('<i class="fa fa-eye"></i> View', array('controller' => 'publishingpoints', 'action' => 'view', $publishingPoint_id),array('escape' => false)); ?></li>
    <li class="active"><i class="fa fa-pencil"></i> Add Source</li>
<?php $this->end(); ?>
<?php echo $this->Form->create('PublishingPointSource'); ?>
<?php echo $this->Form->input('publishing_point_id', array('type' => 'hidden', 'value' => $publishingPoint_id)); ?>
    <div class="col-lg-10">
